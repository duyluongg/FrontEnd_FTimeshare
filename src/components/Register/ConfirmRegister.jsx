...
const ConfirmRegister = () => {
    ...
    const handleVerify = async (e) => {
        ...
        if (code === randomCode) {
            try {
                const response = await axios.put(`https://bookinghomstay.azurewebsites.net/api/users/verify/active/${email}`);
            ...
            if (sendAttempts >= 5) {
                try {
                    const response = await axios.delete(`https://bookinghomstay.azurewebsites.net/api/users/deleteByEmail/${email}`);
    ...
    const handleSendCode = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://bookinghomstay.azurewebsites.net/api/users/sendOTP/', formData, {
                headers: {
