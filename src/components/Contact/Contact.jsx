...
export default function Contact() {
    ...
    return (
        // <MapContainer center={[contactInfo.location.lat, contactInfo.location.lng]} zoom={13} style={{ height: '100vh' }}>
        //   <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
        //   <Marker position={[contactInfo.location.lat, contactInfo.location.lng]}>
        //     <Popup>
