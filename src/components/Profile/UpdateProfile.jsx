...
export default function UpdateProfile({ getData }) {
    ...
    const fetchDataUser = async (getData) => {
        try {
            const response = await axios.get(`https://bookinghomestayfpt.azurewebsites.net/api/users/viewDetail/${getData}`);
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://bookinghomestayfpt.azurewebsites.net/api/users/edit/${getData}`, formData, {
                headers: {
