...
const AcceptedTab = ({ bookingInfoAccepted, images, formatDate, handleCancelActive, loading, isLoadingCancel, loadingStates }) => {
                                            ...
                                            <div class="aAXjeK">
                                                <div>
                                                    {/* <button
                                                        ...
                                                        className={`stardust-button stardust-button--primary QY7kZh ${bookingInfo.bookingStatus.includes('Wait to respond') || bookingInfo.bookingStatus === 'In progress' || isLoadingCancel ? 'disabled' : ''}`}
                                                        disabled={isLoadingCancel || bookingInfo.bookingStatus.includes('Wait to respond') || bookingInfo.bookingStatus === 'In progress'}
                                                    >
                                                ...
                                                {/* {showModal && <ModalConfirmCancel openModalConfirm={() => handleCancelActive(bookingID)} showModalFalse={() => (handleConfirmCancel())}/>} */}
                                            </div>
                                        </section>
                                    </div>
                                </div>
